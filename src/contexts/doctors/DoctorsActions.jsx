...
export const updateDoctor = async (data1, dispatch) => {
  ...
  try {
    const { data } = await axios.put(
      `https://arcane-garden-68747.herokuapp.com/api/doctors/${data1._id}/update`,
      data1,
      {
        headers: {
          authorization:
...
export const changeActive = async (id, dispatch) => {
  try {
    const { data } = await axios.put(
      `https://arcane-garden-68747.herokuapp.com/api/doctors/${id}/activeState`,
      null,
      {
        headers: {
          authorization:
...
export const addVisit = async (data1, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      `https://arcane-garden-68747.herokuapp.com/api/doctors/recordVisit`,
      data1,
      {
        headers: {
          authorization:
...
export const getTotalFeesInDate = async (data1, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      `https://arcane-garden-68747.herokuapp.com/api/doctors/totalFee`,
      data1,
      {
        headers: {
          authorization:
