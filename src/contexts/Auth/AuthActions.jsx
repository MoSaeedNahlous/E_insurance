...
export const doctorRegister = async (body, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      'https://arcane-garden-68747.herokuapp.com/api/doctors/signup',
      body,
      {
        headers: {
          authorization:
...
export const doctorLogin = async (body, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      'https://arcane-garden-68747.herokuapp.com/api/doctors/login',
      body
    );
...
export const patientRegister = async (body, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      'https://arcane-garden-68747.herokuapp.com/api/patients/signup',
      body
    );
    dispatch({ type: 'SIGNUP_SUCCESS', payload: data });
    localStorage.setItem('user', JSON.stringify(data));
...
export const patientLogin = async (body, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      'https://arcane-garden-68747.herokuapp.com/api/patients/login',
      body
    );
    dispatch({ type: 'LOGIN_SUCCESS', payload: data });
    localStorage.setItem('user', JSON.stringify(data));
...
export const pharmacistRegister = async (body, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      'https://arcane-garden-68747.herokuapp.com/api/pharmacists/signup',
      body,
      {
        headers: {
          authorization:
...
export const pharmacistLogin = async (body, dispatch) => {
  ...
  try {
    const { data } = await axios.post(
      'https://arcane-garden-68747.herokuapp.com/api/pharmacists/login',
      body
    );
    dispatch({ type: 'LOGIN_SUCCESS', payload: data });
    localStorage.setItem('user', JSON.stringify(data));
